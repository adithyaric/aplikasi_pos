    ...
    <table class="table" cellspacing="0" border="0" style="margin-bottom:5px; border-top: 1px solid #000; border-collapse: collapse;">
        <tbody>
            <tr>
                ...
                <td style="text-align:right;font-weight:bold;">@currency($penjualan->total + $penjualan->discount)</td>
            </tr>
            ...
            <tr>
                <td colspan="2"
                    style="text-align:left; font-weight:bold; border-top:1px solid #000; padding-top:5px;">Total
                    Keseluruhan</td>
                <td colspan="2"
                    style="border-top:1px solid #000; padding-top:5px; text-align:right; font-weight:bold;">
                    @currency($penjualan->total)</td>
            </tr>
            <tr>
